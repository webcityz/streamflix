export const media = [
  {
    ...
    maturity: "13+",
    duration: "1h 48m",
    image: `${import.meta.env.BASE_URL}images/last-signal.png`,
    backdrop: `${import.meta.env.BASE_URL}images/last-signal-wide.png`,
    description: "A radio engineer receives a message from an abandoned station."
  },
  {
    id: 2,
    title: "Lagos Nights",
    ...
    maturity: "16+",
    duration: "8 episodes",
    image: `${import.meta.env.BASE_URL}images/lagos-nights.png`,
    backdrop: `${import.meta.env.BASE_URL}images/lagos-nights-wide.png`,
    description: "Four lives intersect during one unforgettable night."
  },
  {
    id: 3,
